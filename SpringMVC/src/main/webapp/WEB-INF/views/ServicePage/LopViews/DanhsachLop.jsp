...
<body>
	...
	<form action="/QuanLiLopMVC/lop?page=deletes" method="post">
		<table class="table">
			<thead>
				<tr>
					<th scope="col">#</th>
			...
			<c:forEach var="lop" items="${list}">
				<tbody>
					<tr>
						...
						<td>${lop.soGioHoc}</td>
						<td><a href="/QuanLiLopMVC/mon/form-edit?id=${lop.maLop}">
								<i class="far fa-edit"></i>
						</a> <a href="/QuanLiLopMVC/mon/delete?id=${lop.maLop}"><i
	...
	<div class="row mt-3">
		...
		<c:choose>
			<c:when test="<%=p > 1%>">
				<a href="/QuanLiLopMVC/lop/list-lop?p=<%=p - 1%>">Previous</a>
			</c:when>
			<c:otherwise>
				<a href="/QuanLiLopMVC/lop/list-lop?p=1">Previous</a>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			<c:when test="<%=p < maxPage%>">
				<a href="/QuanLiLopMVC/lop/list-lop?p=<%=p + 1%>">Next</a>
			</c:when>
			<c:otherwise>
				<a href="/QuanLiLopMVC/lop/list-lop?p=${maxPage}">Next</a>
			</c:otherwise>
		</c:choose>
	</div>
