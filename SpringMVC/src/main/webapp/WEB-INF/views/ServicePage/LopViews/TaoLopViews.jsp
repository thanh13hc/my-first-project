	...
	<div class="container-fluid mt-5">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="row">
					<!-- form -->
					<form:form action="/QuanLiLopMVC/lop/add" method="post"
						modelAttribute="lop" cssClass="form-horizontal"
						cssStyle="width: 100%;">
						<div class="form-group offset-sm-1">
							<label for="lopName" class="col-sm-3 control-label">Tên
								lớp học*</label>
							<div class="col-sm-9">
								<form:input path="tenLop" id="lopName" cssClass="form-control"
						...
						<div class="form-group offset-sm-1">
							...
							<div class="col-sm-9">
								<select class="form-control" id="monhocs" name="maMonHoc"
									required="required">
						...
						<div class="form-group offset-sm-1">
							<label for="birthDate" class="col-sm-3  control-label">Ngày
								bắt đầu*</label>
							<div class="col-sm-9">
								<form:input type="date" path="ngayBatdau" id="birthDate"
						...
						<div class="form-group offset-sm-1">
							...
							<label for="birthDate" class="col-sm-3 control-label">Ngày
								kết thúc*</label>
							<div class="col-sm-9">
								<form:input type="date" path="ngayKetthuc" id="birthDate"
									cssClass="form-control" required="required" />
							</div>
						</div>
						<div class="form-group offset-sm-1">
							<label for="Height" class="col-sm-3 control-label">Số giờ
								học* </label>
							<div class="col-sm-9">
								<form:input path="soGioHoc" type="number"  cssClass="form-control" id="height" min="10"
									max="7200"/>
							</div>
						</div>
						<div class="form-group offset-sm-1">
