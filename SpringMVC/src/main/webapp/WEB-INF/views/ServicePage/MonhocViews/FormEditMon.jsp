	...
	<div class="container-fluid mt-5">
		<div class="row">
			...
			<div class="col-sm-6">
				...
				<div class="row">
					<form:form action="/QuanLiLopMVC/mon/edit" modelAttribute="mon"
						method="post" cssStyle="width: 100%;">
					<div class="form-group row">
						<label for="inputEmail"
							class="offset-sm-1 col-sm-3 col-form-label">Mã môn học</label>
						<div class="col-sm-6">
							<form:input path="maMonhoc" id="inputEmail"
								cssClass="form-control-plaintext" readonly="readonly" />
						</div>
					</div>
					<div class="form-group row">
						<label for="inputText" class="offset-sm-1 col-sm-3 col-form-label">Tên
							môn học</label>
						<div class="col-sm-6">
							<form:input path="tenMonhoc" id="inputPassword"
