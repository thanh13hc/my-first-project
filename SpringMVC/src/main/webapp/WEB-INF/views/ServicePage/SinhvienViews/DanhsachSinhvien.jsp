...
<body>
	...
	<form action="/QuanLiLopMVC/sinhvien?page=deletes" method="post">
		<table class="table">
			<thead>
				<tr>
					<th scope="col">#</th>
			...
			<c:forEach var="sinhvien" items="${list}">
				<tbody>
					<tr>
						...
						<td>${sinhvien.ten}</td>
						<td><a
							href="/QuanLiLopMVC/sinhvien?page=form-edit&&id=${sinhvien.maSinhvien}">
								<i class="far fa-edit"></i>
						</a> <a
							href="/QuanLiLopMVC/sinhvien?page=delete&&id=${sinhvien.maSinhvien}"><i
	...
	<div class="row mt-3">
		...
		<c:choose>
			<c:when test="<%=p > 1%>">
				<a href="/QuanLiLopMVC/sinhvien?p=<%=p - 1%>">Previous</a>
			</c:when>
			<c:otherwise>
				<a href="/QuanLiLopMVC/sinhvien?p=1">Previous</a>
			</c:otherwise>
		</c:choose>
		...
		<c:choose>
			<c:when test="<%=p < maxPage%>">
				<a href="/QuanLiLopMVC/sinhvien?p=<%=p + 1%>">Next</a>
			</c:when>
			<c:otherwise>
				<a href="/QuanLiLopMVC/sinhvien?p=${maxPage}">Next</a>
			</c:otherwise>
		</c:choose>
	</div>
