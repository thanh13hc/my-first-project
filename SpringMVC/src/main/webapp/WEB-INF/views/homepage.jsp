		...
		<div id="slide" class="carousel slide" data-ride="arousel">
			...
			<div class="carousel-inner" role="listbox">
				<div class="carousel-item active">
					<img src="<c:url value="/resources/img/img1.jpg"/>" alt="First slide" class="img-fluid">
				</div>
				<div class="carousel-item">
					<img src="<c:url value="/resources/img/img2.jpg"/>" alt="Second slide" class="img-fluid">
				</div>
				<div class="carousel-item">
					<img src="<c:url value="/resources/img/img3.jpg"/>" alt="Third slide" class="img-fluid" />
				</div>
			</div>
