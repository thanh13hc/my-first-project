...
<body>
	...
	<form action="/MySpringCoreSite/lop?page=delete" method="post">
		<table>
			<tr>
				<th>STT</th>
				<th>Mã lớp</th>
			...
			<tr>
				...
				<td>${lop.maLop}</td>
				<td>${lop.tenLop}</td>
				<td>${lop.khoaLop.tenKhoa}</td>
				<td><a href="/MySpringCoreSite/lop?page=edit?id=${lop.maLop}">Edit</a></td>
				<td><input type="checkbox" name= "lop${lop.maLop}" checked="checked" />Delete</td>
			</tr>
			<%
				stt++;
				numberLop++;
