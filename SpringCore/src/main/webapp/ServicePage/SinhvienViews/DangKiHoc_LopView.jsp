	...
	<div class="container-fluid mt-5">
		<div class="row">
			...
			<div class="col-sm-8">
				...
				<form
					action="/QuanLiLop/sinhvien?page=dang-ki-hoc&&p=<%=request.getParameter("p")%>"
				...
				<c:if test="${message eq null }">
					<div class="row mt-3">
						...
						<c:choose>
							<c:when test="<%=p > 1%>">
								<a href="/QuanLiLop/sinhvien?page=dang-ki-hoc&&p=<%=p - 1%>">Previous</a>
							</c:when>
							<c:otherwise>
								<a href="/QuanLiLop/sinhvien?page=dang-ki-hoc&&p=1">Previous</a>
							</c:otherwise>
						</c:choose>
						...
						<c:choose>
							<c:when test="<%=p < maxPage%>">
								<a href="/QuanLiLop/sinhvien?page=dang-ki-hoc&&p=<%=p + 1%>">Next</a>
							</c:when>
							<c:otherwise>
								<a href="/QuanLiLop/sinhvien?page=dang-ki-hoc&&p=${maxPage}">Next</a>
							</c:otherwise>
						</c:choose>
					</div>
				</c:if>
