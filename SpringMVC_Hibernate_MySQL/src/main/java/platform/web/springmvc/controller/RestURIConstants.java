...
public class RestURIConstants {
	...
	// URI for monhoc
	public static final String DUMMY_MONHOC = "/rest/monhoc/dummy";
	public static final String GET_MONHOC = "rest/monhoc/{id}";
	...
	public static final String GET_LOP = "rest/lop/{id}";
	...
	public static final String GET_SINHVIEN = "rest/sinhvien/{id}";
	...
	public static final String GET_GIAOVIEN = "rest/giaovien/{id}";
