		...
		<div class="row">
			...
			<div class="col-sm-8">
						...
						<c:forEach var="lop" items="${list}">
							<tbody>
								<tr>
									...
									<td>${lop.soGioHoc}</td>
									<td><a
										href="/QuanLiLopMVC/lop/them-sv-gv?id=${lop.maLop}"> Đăng kí</a>
								</td>
								</tr>
							</tbody>
						</c:forEach>
				...
				<div class="row mt-3">
					...
					<c:choose>
						<c:when test="<%=p > 1%>">
							<a href="/QuanLiLopMVC/lop/them-sv-gv-form?p=<%=p - 1%>">Previous</a>
						</c:when>
						<c:otherwise>
							<a href="/QuanLiLopMVC/lop/them-sv-gv-form?p=1">Previous</a>
						</c:otherwise>
					</c:choose>
					...
					<c:choose>
						<c:when test="<%=p < maxPage%>">
							<a href="/QuanLiLopMVC/lop/them-sv-gv-form?p=<%=p + 1%>">Next</a>
						</c:when>
						<c:otherwise>
							<a href="/QuanLiLopMVC/lop/them-sv-gv-form?p=${maxPage}">Next</a>
						</c:otherwise>
					</c:choose>
				</div>
			</div>
